...
def init_matrix_dev(nodes, degree, num_degrees):
    ...
    return a_dev, b_dev, result, result_dev, adjacency_dev, num_degrees_dev

def matrix_op(nodes, degree, adjacency, num_degrees_dev, adjacency_dev, a_dev, b_dev, result_dev, result):
...
if __name__ == "__main__":
    ...
    (a_dev, b_dev, result, result_dev, adjacency_dev, num_degrees_dev) = init_matrix_dev(nodes, degree, num_degrees)

    start = perf_counter()
    ASPL, diameter, sum = matrix_op(nodes, degree, adjacency, num_degrees_dev, adjacency_dev, a_dev, b_dev, result_dev, result)
    end = perf_counter()
